...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vinci Shoes — Premium Mongolian Women's Footwear" },
      {
        name: "description",
        content:
          "Vinci Shoes: premium women's footwear from Ulaanbaatar. Heels, pumps, boots and flats made to be noticed.",
      },
      { name: "author", content: "Vinci Shoes" },
      { property: "og:title", content: "Vinci Shoes — Walk with Intention" },
      {
        property: "og:description",
        content: "Premium Mongolian women's footwear. Tara Center 2F, Ulaanbaatar.",
      },
